...
public class OASAnalyzer extends Analyzer {
  ...
  public OASAnalyzer(String apiSpecification, String operationPath, String operationType)
      throws IDLException {
    this(null, apiSpecification, operationPath, operationType, false);
  }

  public OASAnalyzer(
      String apiSpecification, String operationPath, String operationType, boolean specAsString)
      throws IDLException {
    this(null, apiSpecification, operationPath, operationType, specAsString);
  }

  public OASAnalyzer(
      String idlPath, String apiSpecification, String operationPath, String operationType)
      throws IDLException {
  ...
  @Override
  public Map<String, Map<String, List<String>>> getExplanation(Map<String, String> request)
      throws IDLException {
