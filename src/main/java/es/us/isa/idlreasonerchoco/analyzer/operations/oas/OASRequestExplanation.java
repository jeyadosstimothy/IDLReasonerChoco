...
public class OASRequestExplanation implements Explanation {

    private static final Logger LOG = LogManager.getLogger(OASRequestExplanation.class);
    ...
    public OASRequestExplanation(OASMapper mapper, Map<String, String> request, boolean partial) {
        this.mapper = mapper;
    ...
    public Map<String, Map<String, List<String>>> getExplanation() throws IDLException {
        ...
        try {
            ...
            Map<String, List<String>> invalidRequestParams = getInvalidRequestParamsExplanation(minConflicts);

            if (invalidRequestParams.isEmpty())
                explanation.put("InvalidRequestParamsExplanation", null);
            else
                explanation.put("InvalidRequestParamsExplanation", invalidRequestParams);

            Map<String, List<String>> conflictsIDLExplanation = getConflictsIDLExplanation(minConflicts);

            if (conflictsIDLExplanation.isEmpty())
                explanation.put("IDLConflictsExplanation", null);
            else
                explanation.put("IDLConflictsExplanation", conflictsIDLExplanation);
    ...
    private Map<String, List<String>> getInvalidRequestParamsExplanation(List<Constraint> minConflicts) throws IDLException {
    ...
    private Map<String, List<String>> getConflictsIDLExplanation(List<Constraint> minConflicts) {
        ...
        List<String> idlArithmConstraints = getIDLArithmConstraints(cstrs);
    ...
    private List<String> getIDLArithmConstraints(List<Constraint> cstrs) {
