...
public class AdditionalTests {
  ...
  public void idl4oasTest() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer("./src/test/resources/OAS_example_orig.yaml", "/optionalParams", "get");
  ...
  public void formDataParametersTest() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer("./src/test/resources/stripe_v3.yaml", "/v1/products", "post");
    assertTrue(analyzer.isValidIDL(), "The IDL should be VALID");
  ...
  public void multipleOperationsTest() throws IDLException {
    ...
    assertTrue(
        analyzer.isValidPartialRequest(partiallyValidRequest),
        "The partial request should be VALID");

    Map<String, String> partiallyInvalidRequest = new HashMap<>();
    partiallyInvalidRequest.put("p1", "false");
    partiallyInvalidRequest.put(
        "p7", "a string"); // Violates this dependency: AllOrNone(p6!=p8, p8==p10);
    assertFalse(
        analyzer.isValidPartialRequest(partiallyInvalidRequest),
        "The partial request should be NOT valid");
  ...
  public void defaultAndNonDefaultDataIsValidRequestTest() throws IDLException {
    ...
    assertTrue(
        analyzer.isValidRequest(validRandomRequestBeforeUpdateData), "The request should be VALID");
    ...
    assertFalse(
        analyzer.isValidRequest(validRandomRequestBeforeUpdateData),
        "The data was updated and, according to it, the request should be invalid");
    analyzer.updateData(null);
    assertTrue(
        analyzer.isValidRequest(validRandomRequestBeforeUpdateData),
        "With the default data, the request should be valid");

    analyzer.updateData(inputData);
    Map<String, String> validRandomRequestAfterUpdateData = analyzer.getRandomValidRequest();
    assertTrue(
        analyzer.isValidRequest(validRandomRequestAfterUpdateData), "The request should be VALID");
    assertTrue(
        analyzer.isValidRequest(validRandomRequestAfterUpdateData), "The request should be VALID");
  ...
  public void conflictiveParameterNamesTest1() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer(
            "./src/test/resources/OAS_test_suite_orig.yaml", "/conflictiveParameterNames", "get");

    assertFalse(analyzer.isDeadParameter("type"), "The parameter type should NOT be dead");
    assertFalse(
        analyzer.isDeadParameter("constraint"), "The parameter constraint should NOT be dead");
    assertFalse(
        analyzer.isDeadParameter("with_underscore"),
        "The parameter with_underscore should NOT be dead");
    assertFalse(
        analyzer.isDeadParameter("Accept-Language"),
        "The parameter Accept-Language should NOT be dead");
    assertFalse(
        analyzer.isDeadParameter("index:set"), "The parameter index:set should NOT be dead");
    assertFalse(
        analyzer.isDeadParameter("something[one]"),
        "The parameter something[one] should NOT be dead");
    assertFalse(
        analyzer.isDeadParameter("something[two]"),
        "The parameter something[two] should NOT be dead");
    ...
    assertFalse(
        analyzer.isFalseOptional("type"), "The parameter type should NOT be false optional");
    assertFalse(
        analyzer.isFalseOptional("constraint"),
        "The parameter constraint should NOT be false optional");
    assertFalse(
        analyzer.isFalseOptional("with_underscore"),
        "The parameter with_underscore should NOT be false optional");
    assertFalse(
        analyzer.isFalseOptional("Accept-Language"),
        "The parameter Accept-Language should NOT be false optional");
    assertFalse(
        analyzer.isFalseOptional("index:set"),
        "The parameter index:set should NOT be false optional");
    assertFalse(
        analyzer.isFalseOptional("something[one]"),
        "The parameter something[one] should NOT be false optional");
    assertFalse(
        analyzer.isFalseOptional("something[two]"),
        "The parameter something[two] should NOT be false optional");
    ...
    invalidRequest.put(
        "p10",
        "something different from b.b"); // Violates this dependency: AllOrNone(something[one]!=b.b,
    // b.b==p10);
    assertFalse(analyzer.isValidRequest(invalidRequest), "The request should be NOT valid");
    ...
    partiallyInvalidRequest.put(
        "something[two]",
        "a string"); // Violates this dependency: IF type THEN (with_underscore==true OR (NOT
    // with_underscore)) AND NOT [something[two]] AND p9=='fixed string';
    assertFalse(
        analyzer.isValidPartialRequest(partiallyInvalidRequest),
        "The partial request should be NOT valid");
  ...
  public void conflictiveParameterNamesTest2() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer(
            "./src/test/resources/OAS_test_suite_orig.yaml", "/conflictiveParameterNames2", "get");
  ...
  void randomValidRequestTest(String operation) throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer("./src/test/resources/OAS_test_suite_orig.yaml", "/" + operation, "get");
    Map<String, String> validRequest = analyzer.getRandomValidRequest();
    assertTrue(analyzer.isValidRequest(validRequest), "The request should be VALID");
  ...
  public void updateDataTest() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer(
            "./src/test/resources/OAS_test_suite_orig.yaml",
  ...
  public void updateDataOutOfRangeEnumsForNumbers() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer(
            "./src/test/resources/OAS_test_suite_orig.yaml", "/numberAndIntegerParams", "get");
  ...
  private Map<String, List<String>> getYelpData() {
    ...
    inputData.put(
        "offset",
        Arrays.asList("930", "391", "87", "598", "199", "798", "945", "515", "601", "916"));
    inputData.put(
        "latitude",
        Arrays.asList(
            "41.4248",
    ...
    inputData.put(
        "locale",
        Arrays.asList(
            "cs_CZ", "da_DK", "de_AT", "de_CH", "de_DE", "en_AU", "en_BE", "en_CA", "en_CH",
            "en_GB", "en_HK", "en_IE", "en_MY", "en_NZ", "en_PH", "en_SG", "en_US", "es_AR",
            "es_CL", "es_ES", "es_MX", "fi_FI", "fil_PH", "fr_BE", "fr_CA", "fr_CH", "fr_FR",
            "it_CH", "it_IT", "ja_JP", "ms_MY", "nb_NO", "nl_BE", "nl_NL", "pl_PL", "pt_BR",
            "pt_PT", "sv_FI", "sv_SE", "tr_TR", "zh_HK", "zh_TW"));
    ...
    inputData.put(
        "term",
        Arrays.asList(
            "food", "cinema", "open", "cheap", "public", "exciting", "cafe", "ok", "the", "watch"));
    inputData.put(
        "location",
        Arrays.asList(
            "NYC",
    ...
    inputData.put(
        "attributes",
        Arrays.asList(
            "waitlist_reservation,deals",
            "deals",
            "request_a_quote",
            "gender_neutral_restrooms,hot_and_new,open_to_all",
            "wheelchair_accessible",
            "request_a_quote,open_to_all",
            "request_a_quote,waitlist_reservation"));
    inputData.put(
        "categories",
        Arrays.asList(
            "driveintheater,qigong",
            "trafficticketinglaw,occupationaltherapy,ateliers,driving_schools,drugstores",
            "suppliesrestaurant,homeappliancerepair,surfshop",
            "driveintheater",
            "commissionedartists",
            "taekwondo",
            "afrobrazilian",
            "apartmentagents",
            "african,lasertag",
            "kids_activities,truckrepair"));
    inputData.put(
        "radius",
        Arrays.asList(
            "29782", "15173", "17616", "10720", "23468", "6164", "35502", "25428", "14380",
            "28849"));
    inputData.put(
        "open_at",
        Arrays.asList(
  ...
  public void problematicYelpDependencies() throws IDLException {
    assertTimeoutPreemptively(
        ...
        () -> {
          Analyzer analyzer =
              new OASAnalyzer("./src/test/resources/yelp.yaml", "/businesses/search", "get");
  ...
  public void updateDataYelpDependenciesInvalidRequests() throws IDLException {
    ...
    for (int k = 0; k < invalidRequests.size(); k++) {
      assertFalse(
          analyzer.isValidRequest(invalidRequests.get(k)), "The " + k + "th request is valid");
    }
  }
  ...
  public void updateDataYelpDependenciesValidAndInvalidRequests() throws IDLException {
    ...
    for (int i = 0; i < 4; i++) {
      if (i % 2 == 0) analyzer.updateData(inputData);
      for (int j = 0; j < 3; j++) {
        Map<String, String> request;
        if (i == 0 || i == 3) request = analyzer.getRandomValidRequest();
        else request = analyzer.getRandomInvalidRequest();
  ...
  //        Analyzer analyzer = new OASAnalyzer("./src/test/resources/OAS_test_suite_orig.yaml",
  // "/combinatorial3", "get");
  //        for (int i=0; i<=1000; i++) {
  //            Map<String, String> invalidRequest = analyzer.getRandomInvalidRequest();
  //            // System.out.println(invalidRequest);
  //            assertFalse(analyzer.isValidRequest(invalidRequest), "The request should be NOT
  // valid");
  //        }
  ...
  //                Map<String, String> validRequest = analyzer.getRandomValidRequest();
  //                // System.out.println(invalidRequest);
  //                assertFalse(!analyzer.isValidRequest(validRequest), "The request should be
  // valid");
  //            } else {
  //                Map<String, String> invalidRequest = analyzer.getRandomInvalidRequest();
  //                // System.out.println(invalidRequest);
