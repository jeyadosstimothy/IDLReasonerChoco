...
public class AdditionalTests {
    ...
    public void idl4oasTest() throws IDLException {
        Analyzer analyzer = new OASAnalyzer("./src/test/resources/OAS_example_old.yaml", "/optionalParams", "get");
...
//            assertTrue(p10Data.contains(validRandomRequestAfterUpdateData.get("p10")));
    ...
    public void conflictiveParameterNamesTest1() throws IDLException {
        Analyzer analyzer = new OASAnalyzer("./src/test/resources/conflictiveParameterNames.idl", "./src/test/resources/OAS_test_suite_old.yaml", "/conflictiveParameterNames", "get");
...
//        assertTrue(analyzer.isValidRequest(validPseudoRequest), "The request should be VALID");
    ...
    public void conflictiveParameterNamesTest2() throws IDLException {
        Analyzer analyzer = new OASAnalyzer("./src/test/resources/conflictiveParameterNames2.idl", "./src/test/resources/OAS_test_suite_old.yaml", "/conflictiveParameterNames2", "get");
...
//        assertTrue(analyzer.isValidRequest(validPseudoRequest), "The request should be VALID");
    ...
    public void updateDataTest() throws IDLException {
        Analyzer analyzer = new OASAnalyzer("./src/test/resources/one_dep_onlyone.idl", "./src/test/resources/OAS_test_suite_old.yaml", "/oneDependencyEnumAndIntParams", "get");
