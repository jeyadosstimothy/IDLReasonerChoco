...
public class AdditionalTests {
  ...
  public void idl4oasTest() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer("./src/test/resources/OAS_example_old.yaml", "/optionalParams", "get");
  ...
  public void multipleOperationsTest() throws IDLException {
    ...
    //        assertTrue(analyzer.isValidRequest(validPseudoRequest), "The request should be
    // VALID");
  ...
  public void randomValidRequestCustomDataTest() throws IDLException {
    ...
    //        assertTrue(analyzer.isValidRequest(validRandomRequest), "The request should be
    // VALID");
  ...
  public void defaultAndNonDefaultDataIsValidRequestTest() throws IDLException {
    ...
    //        assertTrue(analyzer.isValidRequest(validRandomRequestBeforeUpdateData, true), "With
    // the default data, the request should be valid");

    //        Map<String, String> validRandomRequestAfterUpdateData =
    // analyzer.getPseudoRandomValidRequest();
    //        assertTrue(analyzer.isValidRequest(validRandomRequestAfterUpdateData), "The request
    // should be VALID");
    //        assertTrue(analyzer.isValidRequest(validRandomRequestAfterUpdateData, true), "The
  ...
  public void conflictiveParameterNamesTest1() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer(
            "./src/test/resources/conflictiveParameterNames.idl",
            "./src/test/resources/OAS_test_suite_old.yaml",
  ...
  public void conflictiveParameterNamesTest2() throws IDLException {
    Analyzer analyzer =
        new OASAnalyzer(
            "./src/test/resources/conflictiveParameterNames2.idl",
            "./src/test/resources/OAS_test_suite_old.yaml",
