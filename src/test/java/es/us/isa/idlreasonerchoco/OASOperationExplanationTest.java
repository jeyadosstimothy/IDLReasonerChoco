...
public class OASOperationExplanationTest {
    ...
    public void no_params() throws IDLException {
        ...
        Map<String, Map<String, List<String>>> result = analyzer.getOASOperationExplanation();

        assertTrue(analyzer.isValidIDL(), "The IDL should be VALID");
        assertNull(result.get("InconsistentIDLExplanation"), "The IDL should has no conflicts!");
        assertNull(result.get("DeadParametersExplanation"), "The IDL should has no DeadParametersExplanation!");
        assertNull(result.get("FalseOptionalParametersExplanation"), "The IDL should has no FalseOptionalParametersExplanation!");
    ...
    public void combinatorial2() throws IDLException {
        ...
        assertNull(result.get("InconsistentIDLExplanation"), "The IDL should has no conflicts!");
        assertNotNull(result.get("DeadParametersExplanation"), "The IDL should has no DeadParametersExplanation!");
        assertNull(result.get("FalseOptionalParametersExplanation"), "The IDL should has no FalseOptionalParametersExplanation!");
    ...
    public void combinatorial6() throws IDLException {
        ...
        Map<String, Map<String, List<String>>> result = analyzer.getOASOperationExplanation();
        assertFalse(analyzer.isValidIDL(), "The IDL should be VALID");
        assertNotNull(result.get("InconsistentIDLExplanation"), "The IDL should has no conflicts!");
        assertNull(result.get("DeadParametersExplanation"), "The IDL should has no DeadParametersExplanation!");
        assertNull(result.get("FalseOptionalParametersExplanation"), "The IDL should has no FalseOptionalParametersExplanation!");
    ...
    public void combinatorial9() throws IDLException {
        ...
        assertNull(result.get("InconsistentIDLExplanation"), "The IDL should has no conflicts!");
        assertNotNull(result.get("DeadParametersExplanation"), "The IDL should has no DeadParametersExplanation!");
        assertNotNull(result.get("FalseOptionalParametersExplanation"), "The IDL should has no FalseOptionalParametersExplanation!");
